...
In this hands-on exercise, the key R package being used is the [**tmap**](https://cran.r-project.org/web/packages/tmap/) package. Besides **tmap** package, four other R packages will be used. They are:
...
Two data setws will be used to create the choropleth map. They are:
