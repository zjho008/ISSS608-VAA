...
![Calendar Heatmap](calendarheatmap.png)
...
![](heatmapcalendar.png) Then we can simply group the count by hour and wkday and plot it, since we know that we have values for every combination there’s no need to further preprocess the data.
...
-   Kam, T.S. (2023). [Chapter 17 Visualising and Analysing Time-oriented Data](https://r4va.netlify.app/chap17)
