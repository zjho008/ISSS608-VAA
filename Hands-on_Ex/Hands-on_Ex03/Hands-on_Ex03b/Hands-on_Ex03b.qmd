...
### [4.1.1]{style="color:grey"} Basic concepts of animation

When creating animations, the plot does not actually move. Instead, many individual plots are built and then stitched together as movie frames, just like an old-school flip book or cartoon. Each frame is a different plot when conveying motion, which is built using some relevant subset of the aggregate data. The subset drives the flow of the animation when stitched back together.

![Animation Concept](animation_concept.jpg)

### [4.1.2]{style="color:grey"} Terminology
...
## [4.2]{style="color:grey"} Getting Started

### [4.2.1]{style="color:grey"} Loading the R packages
...
### [4.2.2]{style="color:grey"} Importing the data
...
-   `mutate` of dplyr package is used to convert [data values of Year field into integer]{.underline}.
:::

Unfortunately, `mutate_each_()` was deprecated in dplyr 0.7.0. and `funs()` was deprecated in dplyr 0.8.0.

![R Studio warning message](warningmsg.jpg)
...
## [4.3]{style="color:grey"} Animated Data Visualisation: gganimate methods
...
### [4.3.1]{style="color:grey"} Building a static population bubble plot
...
### [4.3.2]{style="color:grey"} Building the animated bubble plot
...
## [4.4]{style="color:grey"} Animated Data Visualisation: plotly

In **Plotly R** package, both `ggplotly()` and `plot_ly()` support key frame animations through the `frame` argument/aesthetic. They also support an `ids` argument/aesthetic to ensure smooth transitions between objects with the same id (which helps facilitate object constancy).

### [4.4.1]{style="color:grey"} Building an animated bubble plot: `ggplotly()` method
...
### [4.4.2]{style="color:grey"} Building an animated bubble plot: `plot_ly()` method
...
## [4.5]{style="color:grey"} References
