...
The code chunk below is used to plot sparklines.
...
ggplot(sales_report, aes(x = Month, y = Sales)) +
  ...
  theme_tufte(base_size = 3, base_family = "Helvetica") + # used to simplify the plot
  theme(axis.title = element_blank(), axis.text.y = element_blank(), # to remove the axis
